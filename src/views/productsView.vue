<template lang="">
    ...
    <section class="secNexa">
        <h1 class="prod animate__animated animate__zoomInDown animate__slow">Welcome to our garage</h1>
  ...
  <button @click="sortPrice" class="button" type="button">Sort prices</button>
  </div>
  </div>
