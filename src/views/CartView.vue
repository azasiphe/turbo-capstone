               ...
               <div class="row">
                 <div class="col">
                   <div class="table crud-table" >
                     <table class="table align-middle container-sm table-bordered" style="background-color:lightblue;" >
                       <thead class="thead">
                       ...
                       <tbody style="background-color:lightblue;">
                         <tr v-for="(product,index) in cart" :key="product.prodID">
                           ...
                           <td data-label="Delete" ><button @click="delCart(index)" class="delBtn">Remove</button></td>
                         </tr>
                       </tbody>
                     </table>
                   </div>
